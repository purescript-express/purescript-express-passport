...
import Node.Express.Passport.Unsafe (AddDeserializeUser__Callback, AddDeserializeUser__Implementation__Deserializer, AddDeserializeUser__Implementation__DeserializerCallback, AddSerializeUser__Callback, AddSerializeUser__Implementation__Serializer, AddSerializeUser__Implementation__SerializerCallback, AuthenticateOptions, Authenticate__CustomCallback, Authenticate__CustomCallbackResult(..), Authenticate__Implementation__Callback, Authenticate__Implementation__Options, AuthenticationMessage(..), DeserializedUser(..), LogIn__Implementation__Callback, LoginOptions, SerializedUser(..), _addDeserializeUser, _addSerializeUser, _authenticate, _getUser, _login, defaultAuthenticateOptions, defaultLoginOptions, unsafeAddDeserializeUser, unsafeAddSerializeUser, unsafeAuthenticate, unsafeGetUser, unsafeLogIn) as Exports
